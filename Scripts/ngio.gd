...
var app_id = "56060:1LTIZChr" # Put your app ID from NewGrounds here
var aes_key = "O2Pa5OwqiJfyCqKzL9ikDg==" # Put your AES-128/Base64 encryption key 
...
var leaderboards_ids = [[12610, 12611, 12612, 12613, 12614], [12615, 12616, 12617, 12618, 12619]]
var medal_ids = [[73121, 73122, 73123, 73124, -1], [73126, 73127, 73128, 73129, 73130], 
	[73111, 73112, 73113, 73114, 73115], [73116, 73117, 73118, 73119, 73120], 
	[73106, 73107, 73108, 73109, 73110]]
...
func post_score(level_nb, type_id, score, func_ref = null):
	print("Posting Score: ", level_nb, "-", type_id, " => ID: ", self.leaderboards_ids[type_id][level_nb - 1])
	request("ScoreBoard.postScore", {"id": self.leaderboards_ids[type_id][level_nb - 1], "value": score}, func_ref)
		
func unlock_medal(level_nb, type_id):
	print("Unlocking medal ", level_nb, " - ", type_id)
	
	request("Medal.unlock", {"id": self.medal_ids[type_id - 1][level_nb - 1]})
